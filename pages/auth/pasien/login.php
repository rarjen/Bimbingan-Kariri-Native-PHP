<div class="wrapper vh-100 d-flex flex-column justify-content-center align-items-center">
    <div class="cards border px-5 py-3 rounded-lg" style="width: 30%;">
        <div class="text-group my-4 d-flex flex-column justify-content-center align-items-center">
            <img src="src/asset_files/udinus_logo.jpg" class="text-center w-25 my-3" alt="">
            <h3 class="text-center text-capitalize">Login</h3>
        </div>
        <form>
            <div class="form-group my-4 gap-3">
                <input type="email" class="w-100 px-4 py-3 my-3 rounded-lg border page-link" id="username" placeholder="Email" autocomplete="off">
                <input type="password" class="w-100 px-4 py-3 my-3 rounded-lg border page-link" id="password" placeholder="Password">
            ...
            <div class="form-group d-flex justify-content-between align-items-center">
                <a href="../../../pages/auth/pasien/register.php">Buat Akun</a>
