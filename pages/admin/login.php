...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $queryCheckExist = "SELECT * FROM admin WHERE username = ?";
    ...
    if (mysqli_num_rows($resultCheckExist) <= 0) {
        echo "<script>alert(`Admin belum terdaftar!`)</script>";
        die();
    } else {
        ...
        <div class="cards border px-5 py-3 rounded-lg" style="width: 30%; background-color: white;">
            ...
            <form action="" method="POST">
                <div class="form-group my-4 gap-3">
                    <input type="text" class="w-100 px-4 py-3 my-3 rounded-lg border page-link" id="username" placeholder="Username" autocomplete="off" name="username" required>
